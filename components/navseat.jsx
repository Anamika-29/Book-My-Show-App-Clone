...
class headPanelOptionscb extends Component {
    state={
        Language:[],
formatData
:
...
["Hindi", "English", "Punjabi", "Tamil"]
 ...
 <li style={{paddinghead:"10px"}}> <a class="dropdown-item " href="#" ><input type="checkbox" name="Language" id=""  onClick={this.handleChange} value={st}/>
 ...
 <li style={{paddinghead:"10px"}} > <a class="dropdown-item" href="#"><input type="radio" name="format" id=""  onClick={this.handleChange} value={st}/>
 <b className="text-dark"> {
    st
 }</b></a></li>)}
 ...
 <li style={{paddinghead:"10px"}}> <a class="dropdown-item" href="#"><input type="radio" name="Genre" id=""  onClick={this.handleChange} value={st}/>
 <b className="text-dark"> {
    st
 }</b></a></li>)}
        ...
        export default headPanelOptionscb;